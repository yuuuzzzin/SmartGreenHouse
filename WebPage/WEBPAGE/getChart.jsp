...
<html>
  ...
  <body>
    ...
    <div id="Line_Controls_Chart">
        ...
        <div id="lineChartArea" style="padding:0px 20px 0px 0px; width: 550px; margin:auto"></div>

        <!-- 컨트롤바를 생성할 영역 -->

  	<div id="controlsArea" style="padding:0px 20px 0px 0px;width: 550px; margin:auto"></div>

	<!-- 라인 차트 생성할 영역 -->

        <div id="lineChartArea2" style="padding:0px 20px 0px 0px; width: 1000px; margin:auto"></div>

        <!-- 컨트롤바를 생성할 영역 -->

  	<div id="controlsArea2" style="padding:0px 20px 0px 0px;width: 1000px; margin:auto"></div>
  ...
  var chartDrowFun = {
	...
	//alert('!');
        ...
        var controlLineCount	= 7;

	alert('주간그래프가 생성되었습니다.');
