...
public class FanReservationActivity extends AppCompatActivity {
    Button btnStart, btnEnd, btnReserve, btnInit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fan_reservation);
        ...
        btnInit = (Button) findViewById(R.id.button5);
        ...
        btnReserve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                reserveFan(readID, txtStart, txtEnd);
        ...
        btnInit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                initDevice(readId(), "FAN");
                Toast.makeText(getApplicationContext(), "쿨링팬 설정 시간을 초기화하였습니다.", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void reserveFan(final String id, final String start, final String end)
    {
        RequestQueue queue = Volley.newRequestQueue(getApplicationContext());
        String Url = getString(R.string.reservedFanUrl); //온습도를 받아오는 url
